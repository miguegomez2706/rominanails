        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-2">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-3">
              <a href={businessInfo?.whatsapp ? `https://wa.me/${businessInfo.whatsapp.replace(/\D/g,'')}` : "https://wa.me/5493624940856"} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-4 bg-green-50 hover:bg-green-100 rounded-[2rem] transition-colors group">
              ...
              <a href="https://www.instagram.com/romina_gomez_nails_art/" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-4 bg-pink-50 hover:bg-pink-100 rounded-[2rem] transition-colors group">
                ...
                <div><p className="font-semibold text-gray-900 leading-tight">Instagram</p><p className="text-xs text-gray-500">@romina_gomez_nails_art</p></div>
              </a>
              <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-[2rem]">
                ...
                <div><p className="font-semibold text-gray-900 leading-tight">Ubicación</p><p className="text-xs text-gray-500">{businessInfo?.address || 'Necochea 307 OF 3, Resistencia'}</p></div>
              </div>
            </motion.div>
          </div>
        </div>
