      ...
      <section className="pt-20 pb-24 bg-[#fdfbfb] relative overflow-hidden min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col items-center mb-16 text-center">
            <a href="https://www.instagram.com/estudio_romina_gomez/" target="_blank" rel="noreferrer" className="group flex flex-col items-center">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight group-hover:text-[#bc1888] transition-colors">@estudio_romina_gomez</h1>
            </a>
          </div>
          ...
          <div className="mt-16 text-center">
            <a href="https://www.instagram.com/estudio_romina_gomez/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center px-10 py-4 rounded-full bg-gray-900 text-white font-bold hover:bg-[#bc1888] transition-colors uppercase tracking-[0.2em] text-xs shadow-xl hover:shadow-[0_20px_40px_rgba(188,24,136,0.3)]">
